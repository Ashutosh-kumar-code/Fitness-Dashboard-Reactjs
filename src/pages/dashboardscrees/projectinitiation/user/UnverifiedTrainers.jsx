...
const UnverifiedTrainers = () => {
  const [trainers, setTrainers] = useState([]);

  // Fetch unverified trainers from API
  useEffect(() => {
    fetchTrainers();
  }, []);
  ...
  const fetchTrainers = async () => {
    try {
      const response = await axios.get(`${API_URL}/admin/trainers/unverified`);
  ...
  return (
    <div className="">
      ...
      <div className="list-header">
        <h1 className="list-heading">Unverified Trainers List</h1>
      </div>
...
export default UnverifiedTrainers;
